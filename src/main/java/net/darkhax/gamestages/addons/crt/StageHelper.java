...
import com.blamejared.crafttweaker.impl.event.ZenEventManager;
...
public class StageHelper {
    ...
    public static void grantStageOnKill(@Nullable BiPredicate<Player, LivingEntity> condition, @Nullable BiConsumer<Player, LivingEntity> hook, String... stages) {
        ...
        ZenEventManager.EVENTS.register(LivingDeathEvent.class, event -> {
    ...
    public static void grantStageOnDimension(@Nullable DimensionCondition condition, @Nullable DimensionHook hook, String... stages) {
        ...
        ZenEventManager.EVENTS.register(PlayerEvent.PlayerChangedDimensionEvent.class, event -> {
    ...
    public static void grantStageOnJoin(@Nullable Predicate<Player> condition, @Nullable Consumer<Player> hook, String... stages) {
        ...
        ZenEventManager.EVENTS.register(PlayerEvent.PlayerLoggedInEvent.class, event -> {
    ...
    public static void grantStageOnLevel(IntPredicate levelCondition, @Nullable ObjIntConsumer<Player> hook, String... stages) {
        ...
        ZenEventManager.EVENTS.register(LevelChange.class, event -> {
    ...
    public static void grantStageWhenCrafting(Predicate<IItemStack> predicate, @Nullable BiConsumer<Player, IItemStack> hook, String... stages) {
        ...
        ZenEventManager.EVENTS.register(PlayerEvent.ItemCraftedEvent.class, event -> {

            final IItemStack output = IItemStack.of(event.getCrafting());
    ...
    public static void grantStageWhenSmelting(BiPredicate<Player, IItemStack> predicate, @Nullable BiConsumer<Player, IItemStack> hook, String... stages) {
        ...
        ZenEventManager.EVENTS.register(PlayerEvent.ItemSmeltedEvent.class, event -> {

            final IItemStack output = IItemStack.of(event.getSmelting());
    ...
    public static void grantStageWhenBrewing(BiPredicate<Player, IItemStack> predicate, @Nullable BiConsumer<Player, IItemStack> hook, String... stages) {
        ...
        ZenEventManager.EVENTS.register(PlayerBrewedPotionEvent.class, event -> {

            final IItemStack output = IItemStack.of(event.getStack());
    ...
    public static void grantStageWhenFishing(FishingCondition predicate, @Nullable FishingHook hook, String... stages) {
        ...
        ZenEventManager.EVENTS.register(ItemFishedEvent.class, event -> {
    ...
    public static void grantStageWhenPickedUp(BiPredicate<Player, IItemStack> predicate, @Nullable BiConsumer<Player, ItemEntity> hook, String... stages) {
        ...
        ZenEventManager.EVENTS.register(PlayerEvent.ItemPickupEvent.class, event -> {
    ...
    public static void grantStageOnCrit(BiPredicate<Player, Entity> predicate, @Nullable BiConsumer<Player, Entity> hook, String... stages) {
        ...
        ZenEventManager.EVENTS.register(CriticalHitEvent.class, event -> {
    ...
    @ZenCodeType.Method
    public static void grantStageOnTrade(IIngredient condition, String... stages) {

        System.out.println(condition.getCommandString());
        grantStageOnTrade(condition, null, stages);
    }

    @ZenCodeType.Method
    public static void grantStageOnTrade(IIngredient item, @Nullable BiConsumer<Player, AbstractVillager> hook, String... stages) {

        grantStageOnTrade((player, trade, villager) -> asPredicate(item).test(trade.getResult()), hook, stages);
    }

    @ZenCodeType.Method
    public static void grantStageOnTrade(TriPredicate<Player, MerchantOffer, AbstractVillager> predicate, String... stages) {

        grantStageOnTrade(predicate, null, stages);
    }

    @ZenCodeType.Method
    public static void grantStageOnTrade(TriPredicate<Player, MerchantOffer, AbstractVillager> predicate, @Nullable BiConsumer<Player, AbstractVillager> hook, String... stages) {

        ZenEventManager.EVENTS.register(TradeWithVillagerEvent.class, event -> {

            if (event.getEntity() instanceof ServerPlayer player && predicate.test(player, event.getMerchantOffer(), event.getAbstractVillager())) {

                if (grantStages(player, stages) && hook != null) {

                    hook.accept(player, event.getAbstractVillager());
                }
            }
        });
    }
    ...
    private static Predicate<ItemStack> asPredicate(IIngredient ingredient) {

        return stack -> {

            final IItemStack crtStack = IItemStack.of(stack);
            return ingredient.matches(crtStack);
        };
    }
    ...
    private static boolean anyMatch(IIngredient ingredient, List<ItemStack> stacks) {
        ...
        for (ItemStack stack : stacks) {
            ...
            if (ingredient.matches(IItemStack.of(stack))) {
    ...
    @ZenRegister
    @ZenCodeType.Name("mods.gamestages.TriPredicate")
    @FunctionalInterface
